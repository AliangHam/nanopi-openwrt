...
set +e
wget http://10.10.10.50:5088/Application/Openwrt/r2s.img.gz -O- | gzip -dc > $board_id.img
if [ $? -eq 0 ]; then
	wget http://10.10.10.50:5088/Application/Openwrt/r2s.img.md5 -O md5sum.txt
